...
let menuLinks = document.querySelectorAll('.nav__item__link');
...
menuLinks.forEach( 
  function(menuLinks) { 
    menuLinks.addEventListener("click", menuActive);
  }
)
...
console.log(`Ваша оценка - 150 баллов / 160 баллов
Отзыв по пунктам ТЗ:
...
alert(`This CV under development. Stay Tune`);